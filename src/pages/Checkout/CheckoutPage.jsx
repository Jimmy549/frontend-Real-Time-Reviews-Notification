        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center space-x-8">
            <div className="flex items-center space-x-2">
              <span className="w-6 h-6 bg-gray-300 text-gray-600 rounded-full flex items-center justify-center text-sm">1</span>
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium">REVIEW & PAYMENT</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
              ...
              <div className="space-y-3">
                <label className="flex items-center space-x-3 cursor-pointer">
                  <input 
                    ...
                    className="w-4 h-4"
                  />
                  <span className="text-sm">Standard Delivery (2-3 days) - €3.95</span>
                </label>
                <label className="flex items-center space-x-3 cursor-pointer">
                  <input 
                    type="radio" 
                    ...
                    className="w-4 h-4"
                  />
                  <span className="text-sm">Express Delivery (1 day) - €7.95</span>
                </label>
                <label className="flex items-center space-x-3 cursor-pointer">
                  <input 
                    type="radio" 
                    ...
                    className="w-4 h-4"
                  />
                  <span className="text-sm">Free Delivery (5-7 days) - €0.00</span>
                </label>
              </div>
            </div>
            ...
            <Link
              to="/cart"
              className="inline-block mt-6 border border-gray-300 px-6 py-3 text-sm font-medium text-gray-900 hover:bg-gray-50 transition-colors"
            >
              BACK TO SHOPPING
            </Link>
          </div>
          ...
          <div className="bg-gray-50 p-6">
            ...
            <button
              onClick={async () => {
                ...
                const orderData = {
                  ...
                  paymentData: { cardNumber: '4111111111111111', cvv: '123' }
                };
                ...
                try {
                  ...
                  const mockOrder = {
                    _id: `order_${Date.now()}`,
                    orderNumber: `TEA-${Date.now()}-${Math.floor(Math.random() * 1000)}`,
                  ...
                  const existingOrders = JSON.parse(localStorage.getItem('tea_orders') || '[]');
                  existingOrders.unshift(mockOrder);
                  localStorage.setItem('tea_orders', JSON.stringify(existingOrders));
                  
                  clearCart();
                  navigate('/order-success', { state: { order: mockOrder } });
                }
              }}
              className="block w-full bg-gray-900 text-white py-3 px-4 text-center mt-6 hover:bg-gray-800 transition-colors disabled:bg-gray-400"
            >
              PLACE ORDER NOW
            </button>
            ...
            {/* Payment Methods */}
            <div className="mt-8">
              <h3 className="text-sm font-medium text-gray-900 mb-4">Payment type</h3>
              <div className="flex flex-wrap gap-3">
                ...
                <div className="bg-white border border-gray-300 rounded px-3 py-2 flex items-center justify-center w-16 h-10">
                  <svg className="h-6" viewBox="0 0 48 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="48" height="32" rx="4" fill="white" stroke="#D1D5DB" strokeWidth="1"/>
                    <rect x="8" y="10" width="32" height="3" rx="1" fill="#9CA3AF"/>
                    <rect x="8" y="16" width="20" height="2" rx="1" fill="#D1D5DB"/>
                    <rect x="8" y="20" width="15" height="2" rx="1" fill="#D1D5DB"/>
                  </svg>
                </div>
              </div>
            </div>
            ...
            {/* Delivery Info */}
            <div className="mt-8">
              <h3 className="text-sm font-medium text-gray-900 mb-4">Delivery and retour</h3>
        ...
        {/* Popular This Season */}
        <div className="mt-16">
          <h2 className="text-2xl font-normal text-center text-gray-900 mb-12">
            Popular this season
          </h2>
